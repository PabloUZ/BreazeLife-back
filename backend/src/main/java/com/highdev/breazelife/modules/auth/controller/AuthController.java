...
import com.highdev.breazelife.modules.auth.dto.response.MeResponse;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<MeResponse>> me(Authentication authentication) {
        ...
        return ResponseEntity.ok(ApiResponse.of("User retrieved successfully", 200, "OK", MeResponse.from(user)));
    }
}
