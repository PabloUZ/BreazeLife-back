...
@RestController
@RequestMapping("/api/v1/affiliate/notifications")
@PreAuthorize("hasRole('AFFILIATE')")
public class AffiliateNotificationController {

    private final NotificationService notificationService;

    public AffiliateNotificationController(NotificationService notificationService) {
